...
peopleMap.set('brad', { phone: '555-555-5555', email: 'brad@gamil.com' });
peopleMap.set('jack', { phone: '555-555-5555', email: 'jack@gamil.com' });
peopleMap.set('jill', { phone: '555-555-5555', email: 'jill@gamil.com' });
